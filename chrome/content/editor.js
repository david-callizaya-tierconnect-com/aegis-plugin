...
function Editor(window) {
  ...
  this.app.addObserver({
    ...
    currentFormatChanging: function () {
      ...
      console.log("currentFormatChanging");
      console.log(self.sourceView.text.value);
  ...
  //by david
  window.parent.aegis.onEditorLoaded(this, window);
}
...
Editor.prototype.setRecordingEnabled = function (enabled) {
	console.log("[editor] record="+(enabled?"true":"false"));
